...
awk -F'\t' '$20 == "REFR"' prokaryotes.txt | grep -E "(Bacteroides|Parabacteroides)" | grep -v Firmicutes | sed 's/ /_/g' | awk -F'\t' '{print $1"_"$19,$21"/*protein.faa.gz"}' | xargs -n 2 -P 4 wget -O
```
